# Human Resources Evidence Review Simple RAG

## Project Overview

Human Resources Evidence Review Simple RAG is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.

Human Resources Evidence Review involves analyzing employee data to identify trends, risks, and opportunities for improvement. This project aims to develop a simple RAG (Red, Amber, Green) system to categorize employee performance based on evidence.
...
```text
ai-simple-rag-human-resources-evidence-review-simple-rag-beginner-custom-7/
  backend/
app/
  main.py
  config.py
...
- high_risk_employee: Employees with RAG scores above 70 are considered high-risk.
- trend_detection: Identify trends in employee performance over time.
